        ...
        <DashboardLayout>
            <div className="w-full max-w-7xl mx-auto">
                <header className="mb-6 md:mb-8 border-b pb-4 border-gray-200">
                    ...
                    <p className="text-sm md:text-base text-gray-500 mt-1">Manage your account and preferences.</p>
                </header>
                                    ...
                                    <div className="bg-gray-50 p-5 rounded-lg border border-gray-200">
                                        ...
                                        <form onSubmit={handleProfileUpdate} className="space-y-4">
                                            ...
                                            <button
                                                type="submit"
                                                disabled={loading}
                                                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-indigo-700 transition font-medium disabled:opacity-50"
                                            >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-md p-6">
                            ...
                            <p className="text-xs text-gray-400 mt-3 text-center">
                                Securely logout from your current session.
                            </p>
                        </div>
                    </div>
                </div>
